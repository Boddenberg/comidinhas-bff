...
class SuggestionEngine:
    ...
    def calcular(
        ...
        *,
        ...
        mais_facil = self._mais_facil(candidatos, cidade_predominante)
        ...
        aviso = self._montar_aviso(membros_validos, cidades_grupo, cidade_predominante)
    ...
    def _mais_facil(
        ...
        if not scored:
            return None
        motivo = (
            "Tempo medio de deslocamento baixo para o grupo e dados confiaveis."
            if cidade_predominante
            else "Bem localizado e com bons dados publicos."
        )
        return _to_card(
            scored,
